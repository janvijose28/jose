...
# Public variables
The code starts with assigning the name and abbreviation of the token using a string variable. The  name is token name is  'jose' and abbreviation as 'jo'
# Mapping variable
...
contract MyToken {
    ...
    string public tokenName = "jose";
    string public tokenAbbrv = "jo";
